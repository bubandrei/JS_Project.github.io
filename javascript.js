...
var player1;
var player2;
var aliens = [];//инопланетяне
var bullets = []; //пули
var dusts = [];//пыль
var exhausts = [];//выхлоп
var debris = [];//обломки
var powerups = [];//улучшения
...
function UpdateWave() {
	...
	if (aliens.length == 0 && !inMenu) {
		...
		if (!player1.alive) { player1.flyingOnScreen = true; player1.alive = true; player1.hasControl = true; player1.health = 0; }
		if (!player2.alive) { player2.flyingOnScreen = true; player2.alive = true; player2.hasControl = true; player2.health = 0; }
...
/////////////////////////////// --- Draw Menu ---
function DrawMenu()//////НАписано
{
	/////////////////////Сделано
	// Title text Добавлено название 
